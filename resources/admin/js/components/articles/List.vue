      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t('menu.list-of-articles') }}</h3>
  ...
  export default {
    ...
    methods: {
      ...
      show: function(record) {
        axios
          .put(`/api/articles/${record.id}`, { published: !record.published })
          .then(() => {
      ...
      edit: function (record) {
        this.$router.push({ name: 'article-edit', params: {id: record.id} });
      },
