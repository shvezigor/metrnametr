      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            <h3 class="card-title">{{ $t('menu.list-of-vacancies') }}</h3>
  ...
  export default {
    ...
    methods: {
      ...
      show: function(record) {
        axios
          .put(`/api/vacancies/${record.id}`, { published: !record.published })
          .then(() => {
      ...
      create: function () {
        this.$router.push({name: 'vacancies-create'})
      },

      edit: function (record) {
        this.$router.push({ name: 'vacancies-edit', params: {id: record.id} });
      },
      ...
      remove: function (record, index) {
        ...
        axios
          .delete(`/api/vacancies/${record.id}`)
          .then(response => {
